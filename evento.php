...
<ul id="dropdown2" class="dropdown-content">
  ...
  <li><a href="reservacion2.php">Reservaciones para hoy</a></li>
			...
			<nav class="green">
				<div class="nav-wrapper ">
					...
					<ul class="right hide-on-med-and-down">
						...
						<li><a class="green darken-1"  href="evento.php">Evento</a></li>
		...
		<div class="container">
			<div class="row">
				<a class=" btn tooltipped btn-floating btn-large cyan pulse modal-trigger green " data-position="bottom" data-tooltip="Agregar nuevo evento" href="#modal2"><i class="material-icons">edit</i></a>
		...
		<div class="row" id="tabla_registro">
				...
				<div class="col 14">
					<div class="modal-content ">
						<div class="container ">
							...
							<h4 class="center-align"> Nuevo Evento</h4></div></div>
							<div class="divider"></div>
							<form id="frm_evento" method="post" autocomplete="off">
								
								<div class="input-field col s6">
									<i class="material-icons prefix">person_outline</i>
									<input type="text" name="descripcion"  value="" id="descripcion" class="validate" >
									<label for="descripcion">Descripcion</label>
								</div>
								<div class="input-field col s6">
									<i class="material-icons prefix">person</i>
									<input type="text" name="fecha" class="datepicker" id="fecha" class="validate" placeholder="Fecha">
									
								</div>
								
								<div class="input-field col s6">
									<i class="material-icons prefix">person</i>
									<input type="text" name="hora"class="timepicker" id="hora" class="validate" placeholder="Hora">
								</div>
								
							</div>
							<div class="modal-footer">
								<div class="input-field col s6">
									<button type="submit" name="btn-evento" id="btn-evento" class="btn-small green">Guardar</button>
						...
						<table class="display responsive nowrap" id="Tablass">
							...
							<tbody>
								...
								<tr>
									...
									<td><button class="btn-small modal-trigger green" data-target="modal1" id="ver_modal" onclick="actualizar('<?php echo $Dato ?>')">Editar<i class="material-icons">add</i></button></td>
				...
				<div id="modal1" class="modal ">
					<div class="modal-content">
						<h4 class="center-align"> Actualizar</h4>
							<div class="divider"></div>
						<form id="frm_actualizar_evento" method="post" autocomplete="off">
							...
							<div class="input-field">
								...
								<label for="m_nombre">Descripcion</label>
							</div>
							<div class="input-field">
								<input type="text" name="m_dni"  value="" id="m_dni" placeholder="">
								<label for="m_dni">Fecha</label>
							</div>
							<div class="input-field">
								<input type="text" name="m_telefono"  value="" id="m_telefono" placeholder="">
								<label for="m_telefono">Hora </label>
							</div>
						</div>
						<div class="modal-footer">
							<div class="input-field">
								<button type="submit" name="btn-actualizar-evento" id="btn-actualizar-evento" class="btn-small green">Guardar</button>
			...
			<div id="modal3" class="modal">
				<div class="modal-content">
					...
					<form id="eliminar_eventos" method="post">
						<div class="input-field">
							<input type="hidden" name="e_id"  value="" id="e_id" placeholder="">
						</div>
					</div>
					<div class="modal-footer">
						<button type="submit" name="btn-eliminar-evento" id="btn-eliminar-evento" class="btn-small red">Eliminar</button>
